...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, sizeof(::doc_server_proto::Request)},
  { 9, 18, sizeof(::doc_server_proto::Item)},
  { 22, 29, sizeof(::doc_server_proto::Response)},
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\014server.proto\022\020doc_server_proto\"+\n\007Requ"
      "est\022\021\n\ttimestamp\030\001 \002(\003\022\r\n\005query\030\002 \002(\t\"G\n"
      "\004Item\022\r\n\005title\030\001 \002(\t\022\014\n\004desc\030\002 \002(\t\022\020\n\010ju"
      "mp_url\030\003 \002(\t\022\020\n\010show_url\030\004 \002(\t\"C\n\010Respon"
      "se\022\021\n\ttimestamp\030\001 \002(\003\022$\n\004item\030\002 \003(\0132\026.do"
      "c_server_proto.Item2O\n\014DocServerAPI\022\?\n\006S"
      "earch\022\031.doc_server_proto.Request\032\032.doc_s"
      "erver_proto.ResponseB\003\200\001\001"
  };
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // repeated .doc_server_proto.Item item = 2;
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(18u /* 18 & 0xFF */)) {
