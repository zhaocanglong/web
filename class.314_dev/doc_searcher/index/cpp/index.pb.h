...
class KwdInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:doc_index_proto.KwdInfo) */ {
 public:
  ...
  // repeated .doc_index_proto.Weight value = 2;
  int value_size() const;
  void clear_value();
  static const int kValueFieldNumber = 2;
  const ::doc_index_proto::Weight& value(int index) const;
  ::doc_index_proto::Weight* mutable_value(int index);
  ::doc_index_proto::Weight* add_value();
 ...
 private:
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::doc_index_proto::Weight > value_;
...
inline ::google::protobuf::int32 Pair::beg() const {
  // @@protoc_insertion_point(field_get:doc_index_proto.Pair.beg)
  return beg_;
}
inline void Pair::set_beg(::google::protobuf::int32 value) {
  set_has_beg();
  beg_ = value;
...
// repeated .doc_index_proto.Weight value = 2;
inline int KwdInfo::value_size() const {
  return value_.size();
}
inline void KwdInfo::clear_value() {
  value_.Clear();
}
inline const ::doc_index_proto::Weight& KwdInfo::value(int index) const {
  // @@protoc_insertion_point(field_get:doc_index_proto.KwdInfo.value)
  return value_.Get(index);
}
inline ::doc_index_proto::Weight* KwdInfo::mutable_value(int index) {
  // @@protoc_insertion_point(field_mutable:doc_index_proto.KwdInfo.value)
  return value_.Mutable(index);
}
inline ::doc_index_proto::Weight* KwdInfo::add_value() {
  // @@protoc_insertion_point(field_add:doc_index_proto.KwdInfo.value)
  return value_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::doc_index_proto::Weight >*
KwdInfo::mutable_value() {
  // @@protoc_insertion_point(field_mutable_list:doc_index_proto.KwdInfo.value)
  return &value_;
}
inline const ::google::protobuf::RepeatedPtrField< ::doc_index_proto::Weight >&
KwdInfo::value() const {
  // @@protoc_insertion_point(field_list:doc_index_proto.KwdInfo.value)
  return value_;
}
